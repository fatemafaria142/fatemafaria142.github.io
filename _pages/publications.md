  ...
  <div style="background:white;border-left:5px solid #f97316;border-radius:10px;padding:25px;flex:1 1 100%;max-width:100%;box-shadow:0 4px 6px rgba(0,0,0,0.1);transition:transform 0.2s ease,box-shadow 0.2s ease;margin-top:18px;" onmouseover="this.style.transform='scale(1.01)';this.style.boxShadow='0 5px 10px rgba(0,0,0,0.12)';" onmouseout="this.style.transform='scale(1)';this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
    ...
    <ul style="font-family:'Segoe UI',sans-serif;color:black;margin-top:15px;">
      <li style="margin-bottom:12px;list-style:none;position:relative;padding-left:25px;">
        ...
        <b>Authors:</b> <span style="color:#fb923c">Fatema Tuj Johora Faria</span>, Mukaffi Bin Moin, Busra Kamal Rafa, Swarnajit Saha, Md. Mahfuzur Rahman, Khan Md Hasib, and M.F. Mridha<br/>
        <b>Journal:</b> <em>Mathematics</em> <span style="background:#ffedd5;color:#f97316;padding:2px 8px;border-radius:4px;font-size:0.9em;">Q1</span><br/>
        <div style="margin-top:10px;">
          <a href="javascript:void(0)" onclick="document.getElementById('disaster_identification2025_abstract').style.display=document.getElementById('disaster_identification2025_abstract').style.display==='none'?'block':'none';document.getElementById('disaster_identification2025_bib').style.display='none';" style="background:#f97316;color:white;padding:4px 8px;border-radius:5px;text-decoration:none;margin-right:5px;transition:transform 0.2s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">Abstract</a>
          <a href="https://www.sciencedirect.com/science/article/pii/S2212420925006247" style="background:#ea580c;color:white;padding:4px 8px;border-radius:5px;text-decoration:none;margin-right:5px;transition:transform 0.2s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">PDF</a>
          <a href="https://data.mendeley.com/datasets/7dggbjn5sd/1" style="background:#fbbf24;color:white;padding:4px 8px;border-radius:5px;text-decoration:none;margin-right:5px;transition:transform 0.2s ease;" onmouseover="this.style.transform='scale(1.05)';" onmouseout="this.style.transform='scale(1)';">Dataset</a>
