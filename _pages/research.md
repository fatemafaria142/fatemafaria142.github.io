...
<div class="card-container" style="display: flex; flex-direction: column; gap: 20px;">
  <div class="card" style="background-color: white; border-left: 5px solid #3b82f6; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: The IEEE Region 10 Symposium (TENSYMP 2024)</em></p>
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: MDPI Mathematics (Q1)</em></p>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #10b981; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: International Journal of Information Management Data Insights (Q1)</em></p>
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: MDPI Electronics (Q2)</em></p>
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: 18th International Conference on Information Technology and Applications (ICITA 2024)</em></p>
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Under Review in International Journal of Disaster Risk Reduction (Q1)</em></p>
    </div>
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Submitted to 2025 9th International Conference on Vision, Image and Signal Processing (ICVISP 2025)</em></p>
    </div>
  </div>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #8b5cf6; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="font-style: italic; margin: 5px 0;">Authors: Fatema Tuj Johora Faria, Mukaffi Bin Moin, Asif Iftekher Fahim, Pronay Debnath, Faisal Muhammad Shah</p>
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Accepted in 4th International Conference on Computing and Communication Networks (ICCCNet-2024)</em></p>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #f59e0b; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Submitted to 2025 IEEE 9th International Conference on Software Engineering & Computer Systems (ICSECS)</em></p>
    </div>
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: (Ongoing Work)</em></p>
    </div>
  </div>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #ef4444; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Under Review in Journal of Visual Communication and Image Representation (Q1)</em></p>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #9333ea; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Under Review in Neural Computing and Applications (Q1)</em></p>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #f97316; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="font-style: italic; margin: 5px 0;">Authors: Mohammad Shafiul Alam, Fatema Tuj Johora Faria, Mukaffi Bin Moin, Ahmed Al Wase, Md. Rabius Sani, Khan Md Hasib</p>
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: Under Review in Journal of Intelligent Information Systems (Q2)</em></p>
  ...
  <div class="card" style="background-color: white; border-left: 5px solid #22c55e; border-radius: 10px; padding: 25px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div class="paper" style="margin: 15px 0; font-family: 'Trebuchet MS', sans-serif; color: black;">
      ...
      <p style="color: green; margin: 5px 0;"><em>Conference or Journal: 2023 IEEE 13th Annual Computing and Communication Workshop and Conference (CCWC)</em></p>
