...
<div class="card-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
  <div class="card" style="background-color: #dbeafe; border-left: 5px solid #3b82f6; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #d1fae5; border-left: 5px solid #10b981; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #ede9fe; border-left: 5px solid #8b5cf6; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #fef3c7; border-left: 5px solid #f59e0b; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #fee2e2; border-left: 5px solid #ef4444; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #f5d0fe; border-left: 5px solid #9333ea; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #ccfbf1; border-left: 5px solid #14b8a6; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #ffedd5; border-left: 5px solid #f97316; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
  ...
  <div class="card" style="background-color: #d1fae5; border-left: 5px solid #22c55e; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease, box-shadow 0.3s ease;">
